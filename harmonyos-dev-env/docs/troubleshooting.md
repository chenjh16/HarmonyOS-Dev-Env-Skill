...
- .so files from arbitrary `$HOME/` subpaths (not installed via pip to `$HOME/.local/`)
...
**Full Guide**: [python-adaptation/packages-detailed.md](python-adaptation/packages-detailed.md)
